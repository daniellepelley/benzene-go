// Command aws-lambda-mesh-analytics is the analytics Lambda: a pure event consumer subscribed to
// payment:captured and shipment:dispatched (both EventBridge) - see
