...
// TestNotifications_DescriptorDeclaresWhatItSends pins notifications as a pure event consumer: it sends
...
func TestNotifications_DescriptorDeclaresWhatItSends(t *testing.T) {
