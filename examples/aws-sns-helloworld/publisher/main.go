...
// Lambda invocations connected only by the topic. Resolving the Sender from the container -
...
// Sender in the container so the egress edge is swappable; main wires the real SNS client,
// a test wires a fake.
